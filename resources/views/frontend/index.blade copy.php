...
@section('content')
    ...
    <section class="container-flued">
        <div class="row p-0 m-0">
            ...
            <div class="col-md-4 login">
                <br><br><br>
                <div class="card text-center" style="max-width: 350px; margin: 0 auto">
                    <div class="card-body">
                        <br>
                        <h4 class="text-center">Please sign in</h4><br><br>
                        @if ($errors->any())
    ...
    <style>
        ...
        .inner-div:hover .front__face-photo,
        .inner-div:hover .front__footer {
            opacity: 0;
        }
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="outer-div" style="margin: 0 auto">
                                <div class="inner-div">
                                    <div class="front">
                                        ...
                                        <div class="front__text">
                                            ...
                                            <p class="front__text-para">Black bengal goat conservation & development
                                                project, BLRI, Savar,
                                                Dhaka</p>
                                ...
                                <div class="inner-div">
                                    <div class="front">
                                        ...
                                        <div class="front__text">
                                            ...
                                            <p class="front__text-para">Goat & sheep production research division, BLRI,
                                                Savar,
                                                Dhaka</p>
                                            {{-- <p class="front__text-para">RTS, Lube Division</p> --}}
                ...
                <div class="col-md-5">
                    ...
                    <div class="col-md-12">
                        <div class="notice">
                            <h3>Test test</h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus voluptatum eveniet
                                incidunt exercitationem maxime deleniti fugiat veniam fuga doloremque possimus, aliquam
                                earum facere, sequi atque laboriosam eius! Dolor, aut aliquam?</p>
