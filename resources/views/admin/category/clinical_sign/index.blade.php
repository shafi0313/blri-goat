        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item active">Clinical Sign Category</li>
                </ul>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Clinical Sign Category</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    {{-- <a href="{{ route('farm.edit', $clinicalSign->id) }}" title="Edit" class="btn btn-link btn-primary btn-lg">
                                                        <i class="fa fa-edit"></i>
                                                    </a> --}}
                                                    <form action="{{ route('farm.destroy', $clinicalSign->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
