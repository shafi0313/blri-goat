        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item active">Add Deworming</li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('deworming.store')}}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" class="form-control @error('deworming_date') is-invalid @enderror" name="deworming_date" value="{{old('deworming_date')}}">
