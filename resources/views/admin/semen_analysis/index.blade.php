                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{route('semen-analysis.create')}}" class="btn btn-primary btn-round ml-auto text-light"><i class="fa fa-plus"></i> Add New</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="multi-filter-select" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $semenAnalysis->animalInfo->sex }} </td>
                                            <td>{{ $semenAnalysis->animalInfo->birth_wt }} </td>
                                            <td>{{ \Carbon\Carbon::parse($semenAnalysis->coll_date)->format('d/m/Y') }} </td>
                                            <td>{{ $semenAnalysis->volume }} </td>
                                            <td>{{ $semenAnalysis->s_color }} </td>
                                            <td>{{ $semenAnalysis->number_of_straw }} </td>
                                            <td>
                                                <div class="form-button-action">
                                                    {{-- <a href="{{route('reproduction-record.edit',$semenAnalysis->id)}}" title="Edit" class="btn btn-link btn-primary btn-lg">
