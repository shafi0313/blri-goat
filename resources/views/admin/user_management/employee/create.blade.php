                            ...
                            <form action="{{ route('employee.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror" value="{{old('designation')}}" placeholder="Enter Designation" required>
                                        @error('designation')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="text" name="bank_ac_no" class="form-control @error('bank_ac_no') is-invalid @enderror" value="{{old('bank_ac_no')}}" placeholder="Enter Bank Account No.">
                                        @error('bank_ac_no')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-sm-3">
                                        ...
                                        <input type="text" name="bank_c_no" class="form-control @error('bank_c_no') is-invalid @enderror" value="{{old('bank_c_no')}}" placeholder="Enter Bank Chequeco No.">
                                        @error('bank_c_no')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-sm-2">
                                        ...
                                        <input type="number" name="salary" class="form-control @error('salary') is-invalid @enderror" value="{{old('salary')}}" placeholder="Enter Salary" required>
                                        @error('salary')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
