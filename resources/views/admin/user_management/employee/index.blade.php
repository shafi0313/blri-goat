                                ...
                                <table id="multi-filter-select" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ ($employeeUser->is_ == 1) ? 'Admin':'Editor' }}</td>
                                            <td>{{ $employeeUser->photo }}</td>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    <a href="admin/users/destroy/{{$employeeUser->id}}" data-toggle="tooltip" title="" class="btn btn-link btn-danger delete" data-original-title="Remove">
