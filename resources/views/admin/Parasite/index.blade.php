                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{route('parasite.create')}}" class="btn btn-primary btn-round ml-auto text-light"><i class="fa fa-plus"></i> Add New</a>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    {{-- <a href="{{route('reproduction-record.edit',$parasite->id)}}" title="Edit" class="btn btn-link btn-primary btn-lg">
